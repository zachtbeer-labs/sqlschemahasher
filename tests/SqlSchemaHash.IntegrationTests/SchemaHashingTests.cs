...
public class SchemaHashingTests : IntegrationTestBase
{
    ...
    public async Task HashWithNormalization_IgnoresAutoGeneratedIndexNames()
    {
        ...
        var exactOptions = new SchemaHashOptions { NormalizeAutoGeneratedIndexNames = false };
    ...
    public async Task SchemaExtractor_ExtractsConstraints()
    {
        ...
        employeesTable.Constraints.Count.ShouldBeGreaterThan(0, "Should extract constraints");
        employeesTable.Constraints.Any(c => c.Type == "FOREIGN KEY").ShouldBeTrue("Should have foreign key constraint");
    }
    ...
    [TestMethod]
    public async Task PublicApi_GetHashAsync_ReturnsBase64Hash()
    {
        // Arrange
        ...
        // Assert - base64 of SHA256 (32 bytes) = 44 chars with padding
        hash1.Length.ShouldBe(44, "Base64-encoded SHA256 should be 44 characters");
    ...
    public async Task PublicApi_GetHashAsync_WithOptions_AppliesOptions()
    {
        ...
        var hashNoProc = await zachtbeer.SqlSchemaHasher.SqlSchemaHash.GetHashAsync(connectionString, new SchemaHashOptions { IncludeStoredProcedureText = false });
    ...
    public async Task NormalizeClusteringType_MatchesClusteredAndNonclustered()
    {
        ...
        // Act
        var exactOptions = new SchemaHashOptions { NormalizeClusteringType = false };
        var normalizedOptions = new SchemaHashOptions { NormalizeClusteringType = true };
    ...
    public async Task AutoGeneratedIndexNames_WithoutNormalization_ProduceDifferentHashes()
    {
        ...
        // Act
        var defaultOptions = new SchemaHashOptions { IncludeStoredProcedureText = false };
        var normalizedOptions = new SchemaHashOptions { NormalizeAutoGeneratedIndexNames = true, IncludeStoredProcedureText = false };
    ...
    public async Task IncludeStoredProcedureText_WhenFalse_IgnoresBodyChanges()
    {
        ...
        // Act
        var withText = new SchemaHashOptions { IncludeStoredProcedureText = true };
        var withoutText = new SchemaHashOptions { IncludeStoredProcedureText = false };
